...
3. Se agregó una función de formato agradable y otra para minimizar los JSON existentes.



## Cómo usar PhotonJSON
...
> **NOTA**
>
> *Antes de continuar, aclaremos que en LiveCode si dos bibliotecas tienen una función con el mismo nombre. Si se llama a esta función desde cualquier otro lado del código, se ejecutará la de la última biblioteca que se llamó, es decir, la primera en la ruta del mensaje.*
...
>
> *Creamos esta librería para ser utilizada en un plugin que se integrará con el IDE de LiveCode y como aclaramos en la nota. Cuando se llama a una función y está en dos bibliotecas, la primera de la ruta tendrá prioridad sobre las demás. Entonces, para no interferir con otros proyectos en los que no desea usar esta biblioteca, decidimos usar esta convención de nomenclatura y no incluir las demás.*
